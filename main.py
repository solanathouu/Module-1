...
#print(f"Taille: {height}, Type: {type(age)}")
#print(f"Nom: {name}, Type {type(name)}")
#print(f"es un etudiant?: {is_student}, Type: {type(is_student)}")
...
# nombre_text = "20"
# nombre_entier = int(nombre_text)
# print(nombre_entier)

# nombre_text_float = 0.2
# nombre_entier_float = int(nombre_text_float)
# print(nombre_entier_float)

# print(type(nombre_entier_float))

# chiffre_en_int = 9
# chiffre_en_string = str(chiffre_en_int)

# print(f"chiffre en string = {type(chiffre_en_string)}")
